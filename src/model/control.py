...
class control(nn.Module):
    def __init__(self, ode_model, *args):
        r"""
    ...
    def forward(self, t, node_f):
        ...
        vel_control = self.U(t, node_f)
        node_n_model[:, -2:] += vel_control
        return node_n_model

class U(nn.Module):
    def __init__(self, model_size, model_dim, xf, T, hid_dim):
        """
    ...
    def forward(self, t, node_f):
        ...
        node_aggregate = scatter_add(edge_emb, self.edge_index[1], dim=0)
